    ...
    <div className="w-full h-screen overflow-hidden">
      <div className="relative w-full h-full">
        ...
        <div className="container_1 text-white z-30 relative py-5">
          ...
          />
          <h1 className="text-2xl text-emerald-400 font-extrabold px-20">
            SHEPHERED OF THE STEPPES
          </h1>
          <div className="heading text-xl text-emerald-400 font-extrabold py-8 px-20">
            FEATURES
          </div>
          <div className="description font-bold px-20 text-base w-[67%]">
            <p>
              Explore the variety of landscape, including
              <span className="text-emerald-400"> mountains, forests, deserts</span>{" "}
              and <span className="text-emerald-400">ancient ruins</span>.
              <br />
              Use the Alabay&apos;s{" "}
            ...
            <p>
              - <span className="text-emerald-400">Time Trials:</span> Compete
              in special timed challenges where the Alabay must navigate
